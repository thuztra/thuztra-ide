...
setpath "product" "licenseUrl" "https://github.com/thuztra/thuztra-ide/blob/master/LICENSE"
setpath_json "product" "linkProtectionTrustedDomains" '["https://open-vsx.org"]'
setpath "product" "releaseNotesUrl" "https://go.microsoft.com/fwlink/?LinkID=533483#vscode"
setpath "product" "reportIssueUrl" "https://github.com/thuztra/thuztra-ide/issues/new"
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  # THUZTRA: stable-quality identity rebranded (see THUZTRA.md). GUIDs
  # are freshly generated — colliding with VSCodium's installer identity
  # would make the two products fight over the same registry entries.
  setpath "product" "nameShort" "Thuztra"
  setpath "product" "nameLong" "Thuztra"
  setpath "product" "applicationName" "thuztra"
  setpath "product" "dataFolderName" ".thuztra"
  setpath "product" "linuxIconName" "thuztra"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "thuztra"
  setpath "product" "serverApplicationName" "thuztra-server"
  setpath "product" "serverDataFolderName" ".thuztra-server"
  setpath "product" "darwinBundleIdentifier" "in.thuztra.ide"
  setpath "product" "win32AppUserModelId" "Thuztra.Thuztra"
  setpath "product" "win32DirName" "Thuztra"
  setpath "product" "win32MutexName" "thuztra"
  setpath "product" "win32NameVersion" "Thuztra"
  setpath "product" "win32RegValueName" "Thuztra"
  setpath "product" "win32ShellNameShort" "Thuztra"
  setpath "product" "win32AppId" "{{A482E428-9A7A-4781-9986-DC6805AC924D}"
  setpath "product" "win32x64AppId" "{{D66BCECC-C474-4FD0-A1FC-5770646E7DA7}"
  setpath "product" "win32arm64AppId" "{{BCDDEF47-557B-4592-9C38-CD6FD6DD7686}"
  setpath "product" "win32UserAppId" "{{A3F8A2E5-1294-46FD-9B51-4A734EAEBEF9}"
  setpath "product" "win32x64UserAppId" "{{D3CDE1EC-08C7-4A64-91C1-6D438EDE656B}"
  setpath "product" "win32arm64UserAppId" "{{81242A92-E2EC-41A5-8766-E58FAC9D3922}"
  setpath "product" "tunnelApplicationName" "thuztra-tunnel"
  setpath "product" "win32TunnelServiceMutex" "thuztra-tunnelservice"
  setpath "product" "win32TunnelMutex" "thuztra-tunnel"
  setpath "product" "win32ContextMenu.x64.clsid" "7B1D260F-DFA1-4C9F-B280-C750D14735A9"
  setpath "product" "win32ContextMenu.arm64.clsid" "AE071301-5B23-4597-88BE-6DCF5FA88157"
fi
